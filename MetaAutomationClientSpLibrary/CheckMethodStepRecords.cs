...
namespace MetaAutomationClientSpLibrary
{
    ...
    internal class CheckMethodStepRecords : CheckData
    {
        ...
        /// <returns>timeout as read from XML/artifact, or default of 30000</returns>
        public uint BeginStep(string stepName)
        {
            uint timeout = DataStringConstants.NumericConstants.DefaultTimeoutMilliseconds;
            ...
            lock (m_lockObjectForStepRecords)
            {
                ...
                if (correctStepFound)
                {
                    ...
                    if (timeLimitAttribute != null)
                    {
                        ...
                        timeout = uint.Parse(timeLimitAttribute.Value);
                    }
                }
                ...
                if (!correctStepFound)
                {
                    ...
                    SetTimeLimitAttribute(m_currentStep, timeout);
                }
            }
